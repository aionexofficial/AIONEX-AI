...
const pipelineRequired=["OPENAI_API_KEY","ELEVENLABS_API_KEY","CREATOMATE_API_KEY","TELEGRAM_CHANNEL_ID","TELEGRAM_ADMIN_CHAT_ID"].filter(name=>!process.env[name]?.trim());
